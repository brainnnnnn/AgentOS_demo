                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      {sections.map((section, index) => (
                        <div key={section.id}>
                          <button
                            className={`text-left py-3 w-full transition-all duration-200 text-sm pl-2 flex items-center rounded-md ${
                              activeSection === section.id
                                ? `font-bold bg-white/10`
                                : "text-white/90 hover:text-[#92CBDA] hover:bg-white/5 font-medium"
                            }`}
                            style={{
                              color: activeSection === section.id ? contentsColor : undefined,
                            }}
